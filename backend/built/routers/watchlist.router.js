...
router.get('/seed', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, watchlist_model_1.WatchItemModel.countDocuments()];
            case 1:
                watchItemCount = _a.sent();
                if (watchItemCount > 0) {
                    res.send({ message: 'Watchlist already seeded' });
                    return [2 /*return*/];
                }
                return [4 /*yield*/, watchlist_model_1.WatchItemModel.create(data_1.sample_watchItems)];
            case 2:
                _a.sent();
...
router.get('/', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, watchlist_model_1.WatchItemModel.find()];
            case 1:
                watchlist = _a.sent();
...
router.post('/update', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            return [4 /*yield*/, watchlist_model_1.WatchItemModel.deleteMany({})];
            case 1:
                // clear existing and insert new
                _a.sent();
                return [4 /*yield*/, watchlist_model_1.WatchItemModel.insertMany(req.body)];
            case 2:
                _a.sent();
