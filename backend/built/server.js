...
var stock_router_1 = __importDefault(require("./routers/stock.router"));
var watchlist_router_1 = __importDefault(require("./routers/watchlist.router"));
var portfolio_router_1 = __importDefault(require("./routers/portfolio.router"));
var chart_router_1 = __importDefault(require("./routers/chart.router"));
// connect to MongoDB
...
// setup routes
app.use("/api", stock_router_1.default);
app.use('/api/watchlist', watchlist_router_1.default);
app.use('/api/portfolio', portfolio_router_1.default);
app.use('/api/chart', chart_router_1.default);
// get current time
